...
import type { DistrictManager } from "../../lib/types";
      ...
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-bold text-[#2E2910]">
            District Managers & Local Representatives
          </h2>
          <p className="text-xs text-[#857c4c]">
            Elected representatives and municipal officers managing ward-level
            water requests
          </p>
        </div>
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-[#f2ebd4]">
                  {managers.map((dm) => (
                    ...
                    >
                      <td className="p-3 font-bold text-[#2E2910]">
                        {dm.name}
                      </td>
